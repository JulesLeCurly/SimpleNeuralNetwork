...
class model():
    def __init__(
        ...
        if not isinstance(NeuralNetwork_structure, list):
            raise TypeError("""
...
""")
        ...
        if not NeuralNetwork_structure or NeuralNetwork_structure == []:
        ...
        self.nb_layers = len(NeuralNetwork_structure)
    ...
    def train(
        ...
        """        # Display learning curves if requested
        if show:
